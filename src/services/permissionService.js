...
const ROTAS_ENCARREGADO = [
  // IMPORTANTE: manter esta matriz independente de ROTAS_AUXILIAR.
  // O Encarregado do SVDD já possui fluxo validado e não deve perder
  // permissões quando o perfil Auxiliar for restringido.
  ROTAS.DASHBOARD,
  ROTAS.CENTRAL_OPERACIONAL,
  ROTAS.MANUTENCOES,
  ROTAS.PAGAR_MATERIAL,
