...
import '../../HT/styles/HTManutencaoModal.css'

const TIPOS_NOVIDADE = [
  'MANUTENÇÃO PREVENTIVA',
  'MANUTENÇÃO CORRETIVA',
  'FALHA NA GRAVAÇÃO',
  'DEFEITO NA IMAGEM / LENTE',
  'DEFEITO NO ÁUDIO / MICROFONE',
  'BATERIA / ALIMENTAÇÃO',
...
export default function COPManutencaoModal({
  cop,
  salvando = false,
  onClose,
  onConfirm
  ...
  useEffect(() => {
    ...
    async function carregarContexto() {
      try {
        ...
        console.warn(
          'Não foi possível carregar o contexto de manutenção da COP:',
          error
        )
      } finally {
        if (ativo) {
  ...
  const fotoPrincipalUrl =
    fotoCadastroPrincipal?.url ||
    fotoCadastroPrincipal?.foto_url ||
    cop?.foto_url ||
    ''
        ...
        <div className="ht-manutencao-corpo">
            ...
            <div className="ht-manutencao-contexto-grid">
              <article className="ht-manutencao-contexto-card">
                ...
                {fotoPrincipalUrl ? (
                  <img
                    ...
                    alt={`Foto cadastral da ${identificacao}`}
                  />
                ) : (
                  <div className="ht-manutencao-sem-foto">
                    Sem foto cadastral
                  </div>
                )}
              </article>
              ...
              <article className="ht-manutencao-contexto-card ht-manutencao-ultima">
                ...
                {carregandoContexto ? (
                  ...
                  <>
                    <strong>
                      {ultimaManutencao.tipo_novidade ||
                        'MANUTENÇÃO'}
                    </strong>
                    ...
                    <small>
                      Entrada:{' '}
                      {formatarData(
                        ultimaManutencao.registrada_em
                      )}
                      {' · '}
                      Status:{' '}
                  ...
                  <div className="ht-manutencao-sem-historico">
                    Esta COP ainda não possui manutenção registrada.
                  </div>
                )}
              </article>
            </div>
          ...
          <div className="ht-manutencao-aviso">
            ...
            <span>
              ...
              Elas não alteram as observações nem as fotos cadastrais da COP.
            </span>
          </div>

          {erro && (
            <div className="ht-manutencao-erro">
              {erro}
            </div>
          )}
          ...
          <label>
            ...
            <textarea
              ...
              placeholder="Condição da câmera, acessórios entregues ou informação complementar desta ocorrência."
              disabled={salvando}
            />
          </label>
          ...
          <label className="ht-manutencao-fotos">
            ...
            <small>
              Essas imagens serão salvas somente na manutenção. Até 6 fotos, com no máximo 5 MB cada.
            </small>
          </label>
